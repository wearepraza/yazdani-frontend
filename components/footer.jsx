        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-400">
              فونیکسو، فروشگاه آنلاین محصولات دیجیتال با بیش از ۱۰ سال سابقه
              درخشان در ارائه محصولات با کیفیت و خدمات پس از فروش عالی.
            </p>
          ...
          <div>
            ...
            <div className="flex justify-center items-start">
              <a
                ...
                target="_blank"
                href="https://trustseal.enamad.ir/?id=612989&Code=MO9zbfWZqaBDBlzTU6etmFXoDsNKXrXi"
              >
                <img
                  referrerPolicy="origin"
